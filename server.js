...
const Snowflake = require("@theinternetfolks/snowflake").Snowflake; //should contain .Snowflake after url (new addition)
...
mongoose.connect("mongodb+srv://aryan283bh:2548@cluster0.iytltb6.mongodb.net/?retryWrites=true&w=majority", { //password of db is not hidden in an env file for testing purposes
